  ...
  <div class="">
    <div class="flex min-h-screen">
      <nav class="w-64 flex-shrink-0">
        <div class="flex-auto bg-blue-500 text-white h-full">
          <div class="flex flex-col overflow-y-auto">
            <ul class="relative m-0 p-0 list-none h-full">
              <li
                class="text-white text-2xl p-4 w-full flex relative shadow-sm justify-start bg-red-800 border-b-2 border-gray-700"
              >
              ...
              <li
                class="text-white p-4 w-full flex relative shadow-sm justify-start bg-red-800 border-b-2 border-gray-700"
              >
              ...
              <div
                class="text-white flex relative px-4 hover:bg-gray-700 cursor-pointer"
              >
              ...
              <div
                class="text-white-100 flex relative px-4 hover:bg-gray-700 cursor-pointer"
              >
                <div class="mr-4 my-auto">
                  <svg
                    class="fill-current h-5 w-5"
      ...
      <div class="flex flex-col w-full">
        <header class="text-white bg-blue-400 sticky left-auto top-0 right-0">
          <div class="h-12 px-6 flex relative items-center justify-end">
            <button
              class="flex mx-4 text-white hover:text-gray-200 focus:outline-none"
            >
              <svg
                class="h-6 w-6"
                viewBox="0 0 24 24"
